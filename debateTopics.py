debateTopics = {
    ...
    152: 'What is responsible for humans having psychosis?',
    153: 'Should humans ‘deface the coinage’?',
    154: 'What does it mean to be cosmopolitan?',
    155: 'Is lack of empathy advantage or a handicap?',
    156: 'What is the labour theory of value, and do most understand its later usage?',
    157: 'Is man "born free, and he is everywhere in chains"?',
    158: 'Are you a butterfly dreaming of being a human?',
    159: 'Cognitive dissidence is necessary for humans?',
    160: 'Do neural atypical people drive society forward?',
    161: 'Why do humans use counterfactuals?',
    162: 'What is Propaganda?',
    163: 'Do organisations primarily select for obedience?',
    164: 'Can humans ever hold pure knowledge?',
    165: 'Should children’s direction in life be determined earlier?',
    166: 'Should children have more responsibility?',
    167: 'Is consciousness an emergent phenomenon?',
    168: 'Should we fear death?',
    169: 'Is alienisation an increasing problem in modern society?',
    170: 'Are humans naturally more cooperative or competitive?',
    171: 'Does the benefits of technology outweigh its looming destructive potential?',
    172: 'Is socialism at the end of history?',
    173: 'When will society have a new synthesis?',
    174: 'How much is masculinity manufactured by our society?',
    175: 'What does it mean to be ubermensch?',
    176: 'Is slave morality a good theory?',
    177: 'Is warfare better or worse in the 21st century?',
    178: 'Saying ‘surveillance is fine because I have nothing to hide’, is as valid as saying ‘freedom of speech isn’t required as I have nothing to say’, true or false?',
    179: 'Will transhumanism change the essence of humanity?',
    180: 'If you could clone yourself which one would be the ‘real’ you?',
    181: 'What drives society, the base or the superstructure?',
    182: 'Why do political terms change their meaning?',
    183: 'What will the world look like 75 years from now?',
    184: 'Will we have another world war?',
    185: 'Is human consciousness more important than the rest of life on earth?',
    186: 'Are people’s politics determined by their psychology?',
    187: 'Are we solely responsible for giving our lives meaning?',
    188: 'Is there such a thing as a collective unconscious?',
    189: 'Is the protestant work ethic a good theory?',
    190: 'Is the nuclear family going to be predominant for the rest of human history?',
    191: 'What comes after capitalism?',
    192: 'Are corporations effectively governments?',
    193: 'What is a just war?',
    194: 'What is democracies greatest strength?',
    195: 'What is democracies greatest Weakness?'
}
